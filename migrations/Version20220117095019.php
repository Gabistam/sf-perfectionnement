 ...
 */
final class Version20220117095019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, writer_id INT NOT NULL, categories_id INT NOT NULL, writers_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, published TINYINT(1) NOT NULL, date DATE NOT NULL, UNIQUE INDEX UNIQ_23A0E6612469DE2 (category_id), UNIQUE INDEX UNIQ_23A0E661BC7E6B6 (writer_id), INDEX IDX_23A0E66A21214B7 (categories_id), INDEX IDX_23A0E66C5686C7A (writers_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
